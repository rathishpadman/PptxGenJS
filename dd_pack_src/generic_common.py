...
NAVY_DEEP   = RGBColor(0x14, 0x28, 0x5C)
INDIGO      = RGBColor(0x2E, 0x4E, 0xC7)
SKY         = RGBColor(0x60, 0x8B, 0xE8)
TEAL        = RGBColor(0x0D, 0x94, 0x88)
TEAL_DEEP   = RGBColor(0x0A, 0x6B, 0x63)
AMBER       = RGBColor(0xD9, 0x77, 0x06)
AMBER_LIGHT = RGBColor(0xFD, 0xE6, 0x8A)
ICE_BLUE    = RGBColor(0xE8, 0xEF, 0xFC)
ICE_TEAL    = RGBColor(0xE3, 0xF3, 0xF1)
GREY_1      = RGBColor(0x64, 0x74, 0x8B)
GREY_2      = RGBColor(0x94, 0xA3, 0xB8)
GREY_3      = RGBColor(0xCB, 0xD5, 0xE1)
GREY_4      = RGBColor(0xEE, 0xF2, 0xF7)
# back-compat aliases so the copied glyph library keeps working unmodified
PURPLE = NAVY; PURPLE_DEEP = NAVY_DEEP; LAVENDER = INDIGO; PERIWINKLE = SKY
BLUE = INDIGO; BRIGHT_BLUE = SKY; LIGHT_BLUE = SKY
FONT = 'Calibri'
I = Inches
